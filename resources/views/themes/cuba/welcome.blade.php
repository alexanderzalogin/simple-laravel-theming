                ...
                <tr>
                    <td align="center">
                        ...
                        <form  action="/" method="POST">
                            @csrf
                            <select name="theme">
                                <option {{old('theme',$theme)=="themes.classic"? 'selected':''}}  value="themes.classic">Classic</option>
                                <option {{old('theme',$theme)=="themes.cuba"? 'selected':''}} value="themes.cuba">Cuba</option>
                            </select>
                            <br><br>
